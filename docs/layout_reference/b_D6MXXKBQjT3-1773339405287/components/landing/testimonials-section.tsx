...
const testimonials = [
  {
    ...
    level: 67,
    content: "SkillQuest completely changed how I approach learning. I've leveled up my coding skills faster than ever before. The gamification makes it addictive in the best way.",
    avatar: "A",
  },
  {
    name: "Maria Santos",
  ...
  },
  {
    ...
    level: 52,
    content: "I've tried every language app out there. SkillQuest is different because it tracks ALL my skills together. My character is now fluent in 3 languages.",
    avatar: "J",
  },
]
