...
const features = [
  ...
  },
  {
    icon: Users,
    title: "Guilds",
    description: "Join or create guilds with friends. Complete group quests and compete on leaderboards.",
    color: "text-primary",
  },
  {
    icon: Target,
    title: "Boss Battles",
    description: "Take on challenging goals as boss battles. Defeat them to earn rare rewards.",
    color: "text-accent",
  },
]
